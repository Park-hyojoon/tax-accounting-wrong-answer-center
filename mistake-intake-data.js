...
(function (root, factory) {
  ...
  return {
    ...
    topics: [
  {id:'reliability-qualitative-characteristics',label:'회계정보의 신뢰성 구성요소'},
  {id:'available-for-sale-disposal-gain-loss',label:'매도가능증권 처분손익'},
  {id:'contra-asset-versus-provision',label:'자산 차감항목과 충당부채'},
  {id:'vat-basic-characteristics',label:'우리나라 부가가치세의 특징'},
  ...
  {id:'exam121-theory-available-for-sale-20260914',source:'user-submitted',evidenceStatus:'confirmed',topicId:'available-for-sale-disposal-gain-loss',title:'유가증권 회계처리 판단',originalCue:'3. 다음 중 유가증권에 대한 설명으로 옳지 않은 것은?\n\n① 유가증권의 취득원가는 매입가액에 취득부대비용을 포함하되, 단기매매증권의 거래수수료는 당기비용으로 처리한다.\n② 매도가능증권은 공정가치로 기말평가를 하되, 시장성이 없는 지분증권의 공정가치를 신뢰성 있게 측정할 수 없는 경우에는 원가법으로 평가한다.\n③ 단기매매증권의 처분손익은 손익계산서에 반영한다.\n④ 매도가능증권의 처분손익은 기타포괄손익누계액에 반영한다.',learnerReason:null,reportedAt:'2026-09-14',registeredDate:'2026-09-14',examRound:121,questionNo:'이론-3',practiceRefs:[{source:'theory',id:'exam121-available-sale-variant',type:'매도가능증권 처분손익'}],provenance:'기출 원본 오답/121회 기출 문제 이론 실무 오답 데이터.md'},
  {id:'exam121-theory-contra-asset-20260914',source:'user-submitted',evidenceStatus:'confirmed',topicId:'contra-asset-versus-provision',title:'재무상태표 항목의 성격 판단',originalCue:'4. 다음 중 재무상태표에서 해당 자산이나 부채 계정의 차감적 평가항목이 아닌 것은?\n\n① 대손충당금\n② 감가상각누계액\n③ 퇴직급여충당부채\n④ 재고자산평가충당금',learnerReason:null,reportedAt:'2026-09-14',registeredDate:'2026-09-14',examRound:121,questionNo:'이론-4',practiceRefs:[{source:'theory',id:'exam121-contra-asset-variant',type:'자산 차감항목과 충당부채'}],provenance:'기출 원본 오답/121회 기출 문제 이론 실무 오답 데이터.md'},
  {id:'exam121-theory-vat-characteristics-20260914',source:'user-submitted',evidenceStatus:'confirmed',topicId:'vat-basic-characteristics',title:'부가가치세의 기본 성격 판단',originalCue:'다음 중 우리나라 부가가치세의 특징으로 옳지 않은 것은?\n\n① 국세이다.\n② 전단계거래액공제법이다.\n③ 물세이다.\n④ 간접세이다.',learnerReason:null,reportedAt:'2026-09-14',registeredDate:'2026-09-14',examRound:121,questionNo:'이론-부가가치세 특징',practiceRefs:[{source:'theory',id:'exam121-vat-characteristics-variant',type:'우리나라 부가가치세의 특징'}],provenance:'기출 원본 오답/121회 기출 문제 이론 실무 오답 데이터.md'},
